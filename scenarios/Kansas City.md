...
# Measles outbreak simulation in Kansas City
...
For Kansas City, the vaccination rate is approximately 90.40%.
...
across the population. We can now run the simulations.
    ...
    Last run speed      : 23.22 million agents x day / second
    ...
    Transition Probabilities:
     ...
     - Latent                      -  0.89  0.10     -     -     -  0.02     -     -     -     -     -
     - Prodromal                   -     -  0.79  0.18     -     -     -     -  0.04     -     -     -
     - Rash                        -     -     -  0.17  0.50  0.17     -     -     -     -     -  0.17
     - Isolated                    -     -     -     -  0.29  0.57     -     -     -     -  0.14     -
     ...
     - Hospitalized                -     -     -     -     -     -     -     -     -     -  0.75  0.25
     - Recovered                   -     -     -     -     -     -     -     -     -     -     -  1.00

![](Kansas-City_files/figure-commonmark/plotting-outbreak-size1-1.png)

![](Kansas-City_files/figure-commonmark/plotting-outbreak-size2-1.png)
