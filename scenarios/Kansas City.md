...
across the population. We can now run the simulations.
    ...
    Total elapsed t     : 95.00s (200 runs)
    Last run speed      : 35.63 million agents x day / second
    Average run speed   : 64.97 million agents x day / second
    Rewiring            : off
