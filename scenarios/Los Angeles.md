...
# Measles outbreak simulation in Los Angeles
...
> [!WARNING]
>
> The total population in the census data (3878704) exceeds
> params\$max_pop (1000000). The population will be scaled down to fit
> within the specified maximum population size.

## Baseline scenario

For Los Angeles, the vaccination rate is approximately 96.20%.
...
across the population. We can now run the simulations.
    ...
    Last run speed      : 36.60 million agents x day / second
    Average run speed   : 74.44 million agents x day / second
    Rewiring            : off
    ...
    Transition Probabilities:
     ...
     - Latent                      -  0.88  0.07     -     -     -  0.05     -     -     -     -     -
     - Prodromal                   -     -  0.81  0.19     -     -     -     -     -     -     -     -
     - Rash                        -     -     -  0.50  0.25  0.25     -     -     -     -     -     -
     - Isolated                    -     -     -  0.12  0.50  0.25     -     -     -     -     -  0.12
     - Isolated Recovered          -     -     -     -     -  0.98     -     -     -     -     -  0.02
     - Quarantined Latent          -     -     -     -     -     -  0.80     -  0.20     -     -     -
     - Quarantined Susceptible  0.05     -     -     -     -     -     -  0.95     -     -     -     -
     - Quarantined Prodromal       -     -     -     -  0.22     -     -     -  0.78     -     -     -
     - Quarantined Recovered       -     -     -     -     -     -     -     -     -     -     -     -
     - Hospitalized                -     -     -     -     -     -     -     -     -     -     -     -
     - Recovered                   -     -     -     -     -     -     -     -     -     -     -  1.00

![](Los-Angeles_files/figure-commonmark/plotting-outbreak-size1-1.png)

![](Los-Angeles_files/figure-commonmark/plotting-outbreak-size2-1.png)
