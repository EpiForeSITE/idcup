...
across the population. We can now run the simulations.
    ...
    Last run speed      : 47.51 million agents x day / second
    Average run speed   : 71.58 million agents x day / second
    Rewiring            : off
