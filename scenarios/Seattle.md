...
across the population. We can now run the simulations.
    ...
    Last run speed      : 42.46 million agents x day / second
    Average run speed   : 64.17 million agents x day / second
    Rewiring            : off
