...
across the population. We can now run the simulations.
    ...
    Last run speed      : 29.90 million agents x day / second
    Average run speed   : 58.85 million agents x day / second
    Rewiring            : off
