...
# Measles outbreak simulation in Philadelphia
...
> [!WARNING]
>
> The total population in the census data (1573916) exceeds
> params\$max_pop (1000000). The population will be scaled down to fit
> within the specified maximum population size.

## Baseline scenario

For Philadelphia, the vaccination rate is approximately 93.50%.
...
across the population. We can now run the simulations.
    ...
    Population size     : 1000008
    Agents' data        : (none)
    Number of entities  : 17
    Days (duration)     : 60 (of 60)
    Number of viruses   : 1
    Last run elapsed t  : 0.00m
    Total elapsed t     : 4.00m (200 runs)
    Last run speed      : 26.80 million agents x day / second
    Average run speed   : 49.97 million agents x day / second
    Rewiring            : off
    ...
    Transition Probabilities:
     ...
     - Latent                      -  0.79  0.11     -     -     -  0.11     -     -     -     -     -
     - Prodromal                   -     -  0.60  0.40     -     -     -     -     -     -     -     -
     - Rash                        -     -     -  0.25  0.50  0.25     -     -     -     -     -     -
     - Isolated                    -     -     -  0.12  0.50  0.25     -     -     -     -     -  0.12
     - Isolated Recovered          -     -     -     -     -  0.96     -     -     -     -     -  0.04
     - Quarantined Latent          -     -     -     -     -     -  0.86     -  0.14     -     -     -
     - Quarantined Susceptible  0.05     -     -     -     -     -     -  0.95     -     -     -     -
     - Quarantined Prodromal       -     -     -     -  0.18     -     -     -  0.82     -     -     -
     - Quarantined Recovered       -     -     -     -     -     -     -     -     -     -     -     -
     - Hospitalized                -     -     -     -     -     -     -     -     -     -     -     -
     - Recovered                   -     -     -     -     -     -     -     -     -     -     -  1.00

![](Philadelphia_files/figure-commonmark/plotting-outbreak-size1-1.png)

![](Philadelphia_files/figure-commonmark/plotting-outbreak-size2-1.png)
